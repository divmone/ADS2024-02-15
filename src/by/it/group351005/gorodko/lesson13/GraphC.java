...
public class GraphC {
    ...
    static void dfs(int vertex, boolean[] visited, Stack<Integer> stack, Graph graph) {
        visited[vertex] = true;
    ...
    static List<List<Integer>> transposeGraph(Graph graph) {
    ...
    public static void main(String[] args) {
        ...
        Graph graph = new Graph(getMax(startVertex, endVertex) + (isNumeric ? 0 : 1));
