package by.it.group351003.sologub.lesson14;
//разбиение на группы множеств, кластеров. группирование точек в пространстве. например, точки с маленьким  а с - хононйская башня.
/*Сгруппировать с помощью Дерево непересекающихся множеств в поддеревья все те шаги решения задачи
