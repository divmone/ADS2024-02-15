...
/*Этот код позволяет:
Вводить набор трехмерных точек.
Объединять точки в группы (множества), если расстояние между ними меньше или равно заданному максимальному расстоянию.
Выводить размеры найденных групп.*/
import java.util.*;
