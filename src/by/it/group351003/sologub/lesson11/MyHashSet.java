package by.it.group351003.sologub.lesson11;
...
public class MyHashSet<E> implements Set<E> {
    ...
    private int getHashCode(Object o) { //вычисляет индекс в массиве для заданного объекта на основе его хеш-кода.
    ...
    @Override
    public boolean add(E e) { //Метод добавляет элемент в набор. Если элемент уже существует, он не добавляется.
